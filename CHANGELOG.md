...
- [CHANGED] [BREAKING] changed API for `PooledInlineQueue` construction.
...
- [CHANGED] [BREAKING] renamed `StaticQueue` to `InlineQueue` and `PooledStaticQueue` to `PooledInlineQueue` to better reflect the allocation strategies.
